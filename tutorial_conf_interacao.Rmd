...
### Cálculo do OR de Mantel-Haenszel

```{r}
# Efeito a inatividade sobre a autopercepção de saúde controlada pelo sexo
mantelhaen.test(vigitelSL$inativo, vigitelSL$saruim, vigitelSL$sexo)

```

### Cálculo do OR de cada estrato e pelo test de Mantel-Haenszel

```{r, warning=FALSE, message=FALSE}
library(epiDisplay)
# Efeito a inatividade sobre a autopercepção de saúde controlada pelo sexo
with(vigitelSL, mhor(inativo, saruim, sexo, graph = F))
...
```{r, warning=FALSE, message=FALSE}
library(epiDisplay)
# Efeito a inatividade sobre a autopercepção de saúde controlada pelo escolaridade
with(vigitelSL, mhor(inativo, saruim, fesc, graph = F))
